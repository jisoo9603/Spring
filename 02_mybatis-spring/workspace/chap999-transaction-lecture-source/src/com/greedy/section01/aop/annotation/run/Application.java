...
import com.greedy.section01.aop.annotation.config.ContextConfiguation;
...
public class Application {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context =
				new AnnotationConfigApplicationContext(ContextConfiguation.class);
	...
	orderMenu:
	do {
		System.out.println("========= 트렌젝션 레스토랑 음식 주문 서비스==========");
